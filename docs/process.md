...
현재는 정상 녹화일이 9/9·9/10(부분)·9/21·9/22 4일뿐이라 **1단계에도 한참 못 미친다.**
...
5. **다음 순서**: 실제 데이터(9/9, 9/10, 9/21, 9/22)가 쌓였으니 `scripts/train_lstm.py`로 재학습 → val_accuracy가 이전(0.425)보다 나아졌는지 확인. 실전 전환 기준은 "LSTM 실전 전환 기준" 섹션 참고 — 아직 1단계(데이터 15~20일)에도 못 미침.
